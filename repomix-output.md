...
Generated by Repomix on: 2026-01-01 20:19:41
...
```text
# --- Repomix ---
# Ignorar el archivo de salida por defecto (cualquier extensión)
repomix-output.*
```
...
/* Contenedor de la imagen para centrar */
.lightbox-content {
    position: relative;
    max-width: 90%;
    max-height: 90%;
...
.lightbox-image {
    ...
    border-radius: 0.5rem;
    box-shadow: 0 0 3rem rgba(0, 224, 179, 0.3);
    transform: scale(0.7); /* Zoom inicial pequeño */
    transition: transform 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275);
}

.lightbox-modal.active .lightbox-image {
    transform: scale(1); /* Zoom final normal */
}
